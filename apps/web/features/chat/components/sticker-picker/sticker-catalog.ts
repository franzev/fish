...
export const aquaticStickers: readonly ChatSticker[] = [
  ...
  {
    id: "aquatic-you-got-this-shark",
    phrase: "You got this",
    animal: "reef shark",
    description: "An encouraging reef shark saying you got this",
    src: "/stickers/aquatic/you-got-this-shark.webp",
    styles: ["cute", "hand-drawn", "expressive"],
    keywords: ["you got this", "encourage", "support", "confidence", "shark"],
  },
  {
    id: "aquatic-on-it-tuna",
    phrase: "On it",
    animal: "tuna",
    description: "A determined tuna saying on it",
    src: "/stickers/aquatic/on-it-tuna.webp",
    styles: ["cute", "hand-drawn", "expressive"],
    keywords: ["on it", "working", "action", "right away", "tuna"],
  },
  {
    id: "aquatic-sounds-good-blue-tang",
    phrase: "Sounds good",
    animal: "blue tang",
    description: "An agreeable blue tang saying sounds good",
    src: "/stickers/aquatic/sounds-good-blue-tang.webp",
    styles: ["cute", "hand-drawn", "expressive"],
    keywords: ["sounds good", "agree", "okay", "sure", "blue tang"],
  },
  {
    id: "aquatic-be-right-back-sailfish",
    phrase: "Be right back",
    animal: "sailfish",
    description: "A speedy sailfish saying be right back",
    src: "/stickers/aquatic/be-right-back-sailfish.webp",
    styles: ["cute", "hand-drawn", "expressive"],
    keywords: ["be right back", "brb", "return", "soon", "sailfish"],
  },
  {
    id: "aquatic-keep-going-salmon",
    phrase: "Keep going",
    animal: "salmon",
    description: "A persistent salmon saying keep going",
    src: "/stickers/aquatic/keep-going-salmon.webp",
    styles: ["cute", "hand-drawn", "expressive"],
    keywords: ["keep going", "persist", "continue", "encourage", "salmon"],
  },
  {
    id: "aquatic-thinking-cuttlefish",
    phrase: "Thinking…",
    animal: "cuttlefish",
    description: "A thoughtful cuttlefish pausing to think",
    src: "/stickers/aquatic/thinking-cuttlefish.webp",
    styles: ["cute", "hand-drawn", "expressive"],
    keywords: ["thinking", "considering", "hmm", "pause", "cuttlefish"],
  },
  {
    id: "aquatic-take-your-time-koi",
    phrase: "Take your time",
    animal: "koi carp",
    description: "A calm koi saying take your time",
    src: "/stickers/aquatic/take-your-time-koi.webp",
    styles: ["cute", "hand-drawn", "expressive"],
    keywords: ["take your time", "no rush", "patient", "calm", "koi"],
  },
  {
    id: "aquatic-im-here-orca",
    phrase: "I’m here",
    animal: "orca",
    description: "A reassuring orca saying I’m here",
    src: "/stickers/aquatic/im-here-orca.webp",
    styles: ["cute", "hand-drawn", "expressive"],
    keywords: ["i'm here", "present", "support", "reassure", "orca"],
  },
];
