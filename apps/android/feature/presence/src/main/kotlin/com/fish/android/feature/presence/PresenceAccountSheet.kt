...
private fun PreferenceRow(
    ...
    val displayStatus = when (choice.preference) {
        PresencePreference.Automatic -> com.fish.android.data.presence.PresenceDisplayStatus.Online
        PresencePreference.Away -> com.fish.android.data.presence.PresenceDisplayStatus.Away
        PresencePreference.Busy -> com.fish.android.data.presence.PresenceDisplayStatus.Busy
        PresencePreference.Invisible -> com.fish.android.data.presence.PresenceDisplayStatus.Invisible
    }
    SheetRow(
        label = choice.label,
