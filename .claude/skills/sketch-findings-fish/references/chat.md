...
- **Message lifecycle:** sending → sent → seen, plus a calm **failed** state ("Not sent — tap to try again." — never harsh; the retry is a real focusable `<button>`, per sketch 005).
