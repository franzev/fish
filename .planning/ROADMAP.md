...
- [x] 09-08-PLAN.md — remove the `/chat` route and add dated CSTATE-02/06 + D-09 supersede notes for the community-room target
- [x] 09-09-PLAN.md — draft-safe send-failure recovery: conditional reducer restore and removal of the composer clobber (WR-01 blocker)
...
- [x] 09-13-PLAN.md — portable contract hardening: preserve unresolved sends through hydration (WR-02), monotonic send status (WR-03), grapheme/surrogate-safe <=96 snippet (WR-10) + fixtures/protocol/native-notes sync
...
- [x] 10-07-PLAN.md — make the reconnect lock conversation-owned and prove overlapping A→B recoveries cannot release the active conversation's lock
