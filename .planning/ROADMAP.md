...
**Plans**: 3/3 plans complete
  ...
  - [x] 04-01-PLAN.md — client_profiles schema + column-grant/trigger level freeze + RLS + six verify:rls assertions + [BLOCKING] local apply (Wave 1)
  - [x] 04-02-PLAN.md — /profile essentials view + /profile/edit Server Action safe-edit + a11y prefs + consent (Wave 2)
  - [x] 04-03-PLAN.md — coach read-only /coach/clients/[id] + linked roster rows + release gates (Wave 3)
...
**Wave 1**
  ...
  - [x] 05-01-PLAN.md — schema, RLS, seed, generated types, and live onboarding verification (Wave 1)
  - [x] 05-02-PLAN.md — shared field contracts, validation, renderer, and onboarding conversation components (Wave 1)

**Wave 2** *(blocked on Wave 1 completion)*

  - [x] 05-03-PLAN.md — client onboarding Server Actions, `/onboarding`, autosave, and resume route wiring (Wave 2)
