...
- [x] **PROF-03**: A client can set a minimal set of accessibility preferences (at most three: theme, text-size step, and an optional reduced-motion override) that default to the system setting — no settings buffet
