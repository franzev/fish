...
| 008 | discord-community-reference | What does the Discord community-chat idiom look like, reproduced faithfully, as a reference for the community pivot? | **A · Faithful recreation** — pixel clone of the provided screenshot (author rows, reply splines, role pills/badges, hover bands, date divider); reference artifact, intentionally not monochrome | chat, community, reference, discord, recreation |
