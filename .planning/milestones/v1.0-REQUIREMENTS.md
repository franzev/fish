# Requirements Archive: v1.0 Monochrome Foundations
...
- [x] **TOKN-02**: Tokens use role-based semantic names (e.g. surface, foreground, notice) — no hue names like old-hue-token-a, so color can be layered in later without renaming
